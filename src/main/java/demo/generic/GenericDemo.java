...
public class GenericDemo {
     ...
     * ? super Integer
     * ? extends Number
     * @param integerGenericClassExample
     */
    ...
    public static void main(String[] args) {
        ...
        GenericClass2Example<String,Integer> stringExample2 = new GenericClass2Example<String,Integer>();
        stringExample2.printArray(characters,integers);
    }
}
